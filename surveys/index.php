<?php 
/**
 * index.php is the first page of our SurveySez application It's based on
 ...
 * 
 * @package SurveySez   
 * @author Hanbo <hanbo.yoon@seattlecentral.edu>
 * @version 1.01 2018/02/06
 * @link http://edison.seattlecentral.edu/
...
require 'wn18/inc_0700/config_inc.php'; #provides configuration, pathing, error handling, db credentials 
...
$config->metaKeywords = 'Survey,PHP,Fun,Regular,Regular Expressions,'. $config->metaKeywords;
